...
class FrontPartnersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('central.admin.frontPartners.index');
    }
    ...
    public function create()
    {
        ...
        return view('central.admin.frontPartners.create');
    }
    ...
    public function edit(FrontPartner $frontPartner)
    {
        ...
        return view('central.admin.frontPartners.edit', compact('frontPartner'));
    }
