...
class SettingsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('central.admin.settings.index', compact('settings'));
    }
    ...
    public function create()
    {
        ...
        return view('central.admin.settings.create');
    }
    ...
    public function edit(Setting $setting)
    {
        ...
        return view('central.admin.settings.edit', compact('setting'));
    }
    ...
    public function show(Setting $setting)
    {
        ...
        return view('central.admin.settings.show', compact('setting'));
    }
