...
class UsersController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('central.admin.users.create', compact('roles'));
    }
    ...
    public function edit(User $user)
    {
        ...
        return view('central.admin.users.edit', compact('roles', 'user'));
    }
    ...
    public function show(User $user)
    {
        ...
        return view('central.admin.users.show', compact('user'));
    }
