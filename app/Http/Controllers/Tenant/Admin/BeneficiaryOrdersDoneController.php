...
use App\Http\Requests\Tenant\Admin\MassDestroyBeneficiaryOrdersDoneRequest;
use App\Http\Requests\Tenant\Admin\StoreBeneficiaryOrdersDoneRequest;
use App\Http\Requests\Tenant\Admin\UpdateBeneficiaryOrdersDoneRequest;
...
class BeneficiaryOrdersDoneController extends Controller
{
    public function index()
    {
        ...
        return view('tenant.admin.beneficiaryOrdersDones.index');
    }
    ...
    public function create()
    {
        ...
        return view('tenant.admin.beneficiaryOrdersDones.create');
    }
    ...
    public function edit(BeneficiaryOrdersDone $beneficiaryOrdersDone)
    {
        ...
        return view('tenant.admin.beneficiaryOrdersDones.edit', compact('beneficiaryOrdersDone'));
    }
    ...
    public function show(BeneficiaryOrdersDone $beneficiaryOrdersDone)
    {
        ...
        return view('tenant.admin.beneficiaryOrdersDones.show', compact('beneficiaryOrdersDone'));
    }
