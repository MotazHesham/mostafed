...
use App\Http\Requests\Tenant\Beneficiary\StoreBeneficiaryFamilyRequest;
use App\Http\Requests\Tenant\Beneficiary\UpdateBeneficiaryFamilyRequest;
...
class BeneficiaryFamilyController extends Controller
{
    ...
    public function show(Request $request)
    {
        ...
        $html = view('tenant.beneficiary.families.show', compact('beneficiaryFamily'))->render();
    ...
    { 
        ...
        $html = view('tenant.beneficiary.families.create', compact('beneficiary', 'disability_types', 'family_relationships', 'health_conditions', 'marital_statuses', 'educational_qualifications'))->render();
    ...
    { 
        ...
        $html = view('tenant.beneficiary.families.index', compact('beneficiaryFamilies'))->render();
    ...
    public function edit(Request $request)
    {
        ...
        $html = view('tenant.beneficiary.families.edit', compact( 'beneficiaryFamily', 'disability_types', 'family_relationships', 'health_conditions', 'marital_statuses', 'educational_qualifications'))->render();
