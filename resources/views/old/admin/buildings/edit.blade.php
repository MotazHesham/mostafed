    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.buildings.update", [$building->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_of_floors') ? 'is-invalid' : '' }}" type="number" name="number_of_floors" id="number_of_floors" value="{{ old('number_of_floors', $building->number_of_floors) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_of_apartments') ? 'is-invalid' : '' }}" type="number" name="number_of_apartments" id="number_of_apartments" value="{{ old('number_of_apartments', $building->number_of_apartments) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" name="address" id="address" required>{{ old('address', $building->address) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('latitude') ? 'is-invalid' : '' }}" type="text" name="latitude" id="latitude" value="{{ old('latitude', $building->latitude) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('longitude') ? 'is-invalid' : '' }}" type="text" name="longitude" id="longitude" value="{{ old('longitude', $building->longitude) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('apartment_specifications') ? 'is-invalid' : '' }}" name="apartment_specifications" id="apartment_specifications" required>{{ old('apartment_specifications', $building->apartment_specifications) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('support_services') ? 'is-invalid' : '' }}" name="support_services" id="support_services">{{ old('support_services', $building->support_services) }}</textarea>
