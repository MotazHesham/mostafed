...
@section('content')
    @php
        $breadcrumbs = [
            ...
            [
                'title' => trans('global.edit') . ' ' . trans('cruds.educationalQualification.title_singular'),
                'url' => '#',
            ],
        ];
    @endphp
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST"
                action="{{ route('admin.educational-qualifications.update', [$educationalQualification->id]) }}"
                ...
                @include('utilities.form.text', [
                    ...
                    'isRequired' => true,
                    'value' => $educationalQualification->getTranslation('name', currentEditingLang()),
                ])
