...
@section('content')
    @php
        $breadcrumbs = [
            ...
            ['title' => trans('global.show') . ' ' . trans('cruds.maritalStatus.title_singular'), 'url' => '#'],
        ];
    @endphp
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group">
                <div class="form-group">
                    <a class="btn btn-light mt-3 mb-3" href="{{ route('admin.marital-statuses.index') }}">
                    ...
                    <tbody>
                        ...
                        @foreach (config('panel.available_languages') as $langLocale => $langName)
                            <tr>
                                ...
                                <td>
                                    {{ $maritalStatus->getTranslation('name', $langLocale) }}
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
