...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.beneficiary-families.update", [$beneficiaryFamily->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('beneficiary') ? 'is-invalid' : '' }}" name="beneficiary_id" id="beneficiary_id" required>
                    @foreach($beneficiaries as $id => $entry)
                        <option value="{{ $id }}" {{ (old('beneficiary_id') ? old('beneficiary_id') : $beneficiaryFamily->beneficiary->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $beneficiaryFamily->name) }}">
                @if($errors->has('name'))
                    <div class="invalid-feedback">
                        {{ $errors->first('name') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('gender') ? 'is-invalid' : '' }}" name="gender" id="gender">
                    ...
                    @foreach(App\Models\BeneficiaryFamily::GENDER_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('gender', $beneficiaryFamily->gender) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('dob') ? 'is-invalid' : '' }}" type="text" name="dob" id="dob" value="{{ old('dob', $beneficiaryFamily->dob) }}">
                @if($errors->has('dob'))
                    <div class="invalid-feedback">
                        {{ $errors->first('dob') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $beneficiaryFamily->phone) }}">
                @if($errors->has('phone'))
                    <div class="invalid-feedback">
                        {{ $errors->first('phone') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email" id="email" value="{{ old('email', $beneficiaryFamily->email) }}">
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('family_relationship') ? 'is-invalid' : '' }}" name="family_relationship_id" id="family_relationship_id">
                    @foreach($family_relationships as $id => $entry)
                        <option value="{{ $id }}" {{ (old('family_relationship_id') ? old('family_relationship_id') : $beneficiaryFamily->family_relationship->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('marital_status') ? 'is-invalid' : '' }}" name="marital_status_id" id="marital_status_id">
                    @foreach($marital_statuses as $id => $entry)
                        <option value="{{ $id }}" {{ (old('marital_status_id') ? old('marital_status_id') : $beneficiaryFamily->marital_status->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('health_condition') ? 'is-invalid' : '' }}" name="health_condition_id" id="health_condition_id">
                    @foreach($health_conditions as $id => $entry)
                        <option value="{{ $id }}" {{ (old('health_condition_id') ? old('health_condition_id') : $beneficiaryFamily->health_condition->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('disability_type') ? 'is-invalid' : '' }}" name="disability_type_id" id="disability_type_id">
                    @foreach($disability_types as $id => $entry)
                        <option value="{{ $id }}" {{ (old('disability_type_id') ? old('disability_type_id') : $beneficiaryFamily->disability_type->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('can_work') ? 'is-invalid' : '' }}" name="can_work" id="can_work">
                    ...
                    @foreach(App\Models\BeneficiaryFamily::CAN_WORK_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('can_work', $beneficiaryFamily->can_work) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
