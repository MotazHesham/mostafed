...
@section('content')
@can('beneficiary_family_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.beneficiary-families.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable w-100 datatable-BeneficiaryFamily">
            <thead>
                <tr>
                    <th width="10">
...
@can('beneficiary_family_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.beneficiary-families.massDestroy') }}",
