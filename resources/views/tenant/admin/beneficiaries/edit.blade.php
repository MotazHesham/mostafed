    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.beneficiaries.update", [$beneficiary->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('user') ? 'is-invalid' : '' }}" name="user_id" id="user_id">
                    @foreach($users as $id => $entry)
                        <option value="{{ $id }}" {{ (old('user_id') ? old('user_id') : $beneficiary->user->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('user'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('nationality') ? 'is-invalid' : '' }}" name="nationality_id" id="nationality_id">
                    @foreach($nationalities as $id => $entry)
                        <option value="{{ $id }}" {{ (old('nationality_id') ? old('nationality_id') : $beneficiary->nationality->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('marital_status') ? 'is-invalid' : '' }}" name="marital_status_id" id="marital_status_id">
                    @foreach($marital_statuses as $id => $entry)
                        <option value="{{ $id }}" {{ (old('marital_status_id') ? old('marital_status_id') : $beneficiary->marital_status->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('job_type') ? 'is-invalid' : '' }}" name="job_type_id" id="job_type_id">
                    @foreach($job_types as $id => $entry)
                        <option value="{{ $id }}" {{ (old('job_type_id') ? old('job_type_id') : $beneficiary->job_type->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('educational_qualification') ? 'is-invalid' : '' }}" name="educational_qualification_id" id="educational_qualification_id">
                    @foreach($educational_qualifications as $id => $entry)
                        <option value="{{ $id }}" {{ (old('educational_qualification_id') ? old('educational_qualification_id') : $beneficiary->educational_qualification->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('dob') ? 'is-invalid' : '' }}" type="text" name="dob" id="dob" value="{{ old('dob', $beneficiary->dob) }}">
                @if($errors->has('dob'))
                    <div class="invalid-feedback">
                        {{ $errors->first('dob') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('latitude') ? 'is-invalid' : '' }}" type="text" name="latitude" id="latitude" value="{{ old('latitude', $beneficiary->latitude) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('longitude') ? 'is-invalid' : '' }}" type="text" name="longitude" id="longitude" value="{{ old('longitude', $beneficiary->longitude) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('district') ? 'is-invalid' : '' }}" name="district_id" id="district_id">
                    @foreach($districts as $id => $entry)
                        <option value="{{ $id }}" {{ (old('district_id') ? old('district_id') : $beneficiary->district->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('street') ? 'is-invalid' : '' }}" type="text" name="street" id="street" value="{{ old('street', $beneficiary->street) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('building_number') ? 'is-invalid' : '' }}" type="text" name="building_number" id="building_number" value="{{ old('building_number', $beneficiary->building_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('floor_number') ? 'is-invalid' : '' }}" type="text" name="floor_number" id="floor_number" value="{{ old('floor_number', $beneficiary->floor_number) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('health_condition') ? 'is-invalid' : '' }}" name="health_condition_id" id="health_condition_id">
                    @foreach($health_conditions as $id => $entry)
                        <option value="{{ $id }}" {{ (old('health_condition_id') ? old('health_condition_id') : $beneficiary->health_condition->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('disability_type') ? 'is-invalid' : '' }}" name="disability_type_id" id="disability_type_id">
                    @foreach($disability_types as $id => $entry)
                        <option value="{{ $id }}" {{ (old('disability_type_id') ? old('disability_type_id') : $beneficiary->disability_type->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('can_work') ? 'is-invalid' : '' }}" name="can_work" id="can_work">
                    ...
                    @foreach(App\Models\Beneficiary::CAN_WORK_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('can_work', $beneficiary->can_work) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('incomes') ? 'is-invalid' : '' }}" name="incomes" id="incomes">{{ old('incomes', $beneficiary->incomes) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('expenses') ? 'is-invalid' : '' }}" name="expenses" id="expenses">{{ old('expenses', $beneficiary->expenses) }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('specialist') ? 'is-invalid' : '' }}" name="specialist_id" id="specialist_id">
                    @foreach($specialists as $id => $entry)
                        <option value="{{ $id }}" {{ (old('specialist_id') ? old('specialist_id') : $beneficiary->specialist->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
