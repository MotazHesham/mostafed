...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover w-100 datatable-userUserAlerts">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.userAlert.fields.user_type') }}
                        </th>
                        <th>
                ...
                <tbody>
                    @foreach($userAlerts as $key => $userAlert)
                        <tr data-entry-id="{{ $userAlert->id }}">
                            ...
                            <td>
                                {{ App\Models\UserAlert::USER_TYPE_SELECT[$userAlert->user_type] ?? '' }}
                            </td>
                            <td>
