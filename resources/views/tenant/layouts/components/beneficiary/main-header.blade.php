                ...
                <div class="horizontal-logo">
                    <a href="{{ route('beneficiary.home') }}" class="header-logo">
                        ...
                        <img src="{{ global_asset('assets/images/brand-logos/toggle-dark.png') }}" alt="logo"
                            class="toggle-dark">
                        <img src="{{ global_asset('assets/images/brand-logos/desktop-dark.png') }}" alt="logo"
                            class="desktop-dark">
                        <img src="{{ global_asset('assets/images/brand-logos/toggle-logo.png') }}" alt="logo"
                            class="toggle-logo">
                        <img src="{{ global_asset('assets/images/brand-logos/toggle-white.png') }}" alt="logo"
                            class="toggle-white">
                        <img src="{{ global_asset('assets/images/brand-logos/desktop-white.png') }}" alt="logo"
                            class="desktop-white">
                    </a>
                </div>
            </div>
        ...
        <ul class="header-content-right">
            ...
            <li class="header-element country-selector dropdown">
                ...
                <ul class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center"
                            href="{{ url()->current() }}?change_language=ar">
                            <span class="avatar avatar-rounded avatar-xs lh-1 me-2">
                    ...
                    <ul class="list-unstyled mb-0" id="header-notification-scroll">
                        <li class="dropdown-item">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1 d-flex align-items-start justify-content-between">
                                    <div>
                                        <p class="mb-0 fw-medium"><a href="{{ url('chat') }}">New User
                                                Registered</a></p>
                                        <div class="text-muted fw-normal fs-12 header-notification-text text-truncate">
                                            <span class="text-primary">John Doe</span> has registered as a new user.
                                        </div>
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1 d-flex align-items-start justify-content-between">
                                    <div>
                                        <p class="mb-0 fw-medium"><a href="{{ url('chat') }}">Payment Received</a>
                                        </p>
                                        <div class="text-muted fw-normal fs-12 header-notification-text text-truncate">
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1 d-flex align-items-start justify-content-between">
                                    <div>
                                        <p class="mb-0 fw-medium"><a href="{{ url('chat') }}">Task Completed</a>
                                        </p>
                                        <div class="text-muted fw-normal fs-12 header-notification-text text-truncate">
                                            <span class="text-secondary">"Design Homepage"</span> task was marked as
                                            complete.</div>
            ...
            <li class="header-element dropdown">
                ...
                <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile"
                    ...
                    <div class="d-flex align-items-center">
                        <div>
							@if(auth()->user()->photo)
                                <img src="{{ auth()->user()->photo->getUrl('thumb') }}" alt="img"
                                    class="avatar custom-header-avatar avatar-rounded">
                            @else
                                <span class="avatar avatar-sm badge {{ getRandomColor(auth()->user()->name) }} avatar-rounded profile-timeline-avatar"
                                    data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{ auth()->user()->name }}">
                                    {{ getEnglishEquivalent(auth()->user()->name) }}
                                </span>
                            @endif
                        </div>
                    </div>
                ...
                <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end"
                    ...
                    <li><a class="dropdown-item d-flex align-items-center" href="{{ url('mail-settings') }}"><i
                                class="ri-settings-5-line lh-1 p-1 rounded-circle bg-primary-transparent text-primary me-2 fs-14"></i>Settings</a>
                    </li>
                    <li><a class="dropdown-item d-flex align-items-center" href="#"  onclick="event.preventDefault(); document.getElementById('logoutform').submit();"><i
