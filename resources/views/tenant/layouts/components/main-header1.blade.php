					...
					<ul class="header-content-right">
							...
							<div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
								...
								<ul class="list-unstyled mb-0" id="header-cart-items-scroll">
										...
										<div class="d-flex align-items-center cart-dropdown-item gap-3">
											<div class="lh-1">
												<span class="avatar avatar-md avatar-rounded">
													<img src="{{asset('build/assets/images/ecommerce/jpg/1.jpg')}}" alt="Elegance Wall Clock">
												</span>
											</div>
											<div class="flex-fill">
												<div class="d-flex align-items-center justify-content-between mb-0">
													<div class="mb-0 fw-medium">
														<a href="{{url('cart')}}">Elegance Wall Clock</a>
									...
									<li class="dropdown-item">
										<div class="d-flex align-items-center cart-dropdown-item gap-3">
											<div class="lh-1">
												<span class="avatar avatar-md avatar-rounded">
													<img src="{{asset('build/assets/images/ecommerce/jpg/2.jpg')}}" alt="Sports Shoe">
												</span>
											</div>
											<div class="flex-fill">
												<div class="d-flex align-items-center justify-content-between mb-0">
													<div class="mb-0 fw-medium">
														<a href="{{url('cart')}}">Sports Shoe</a>
														<div class="d-flex gap-2 text-truncate fs-12 fw-normal text-muted lh-1 mt-1">
									...
									<li class="dropdown-item">
										<div class="d-flex align-items-center cart-dropdown-item gap-3">
											<div class="lh-1">
												<span class="avatar avatar-md avatar-rounded">
													<img src="{{asset('build/assets/images/ecommerce/jpg/3.jpg')}}" alt="Medium Back Pack">
												</span>
											</div>
											<div class="flex-fill">
												<div class="d-flex align-items-center justify-content-between mb-0">
													<div class="mb-0 fw-medium">
														<a href="{{url('cart')}}">Medium Back Pack</a>
														<div class="d-flex gap-2 text-truncate fs-12 fw-normal text-muted lh-1 mt-1">
									...
									<li class="dropdown-item">
										<div class="d-flex align-items-center cart-dropdown-item gap-3">
											<div class="lh-1">
												<span class="avatar avatar-md avatar-rounded">
													<img src="{{asset('build/assets/images/ecommerce/jpg/4.jpg')}}" alt="BloomCraft Pot">
												</span>
											</div>
											<div class="flex-fill">
												<div class="d-flex align-items-center justify-content-between mb-0">
													<div class="mb-0 fw-medium">
														<a href="{{url('cart')}}">BloomCraft Pot</a>
														<div class="d-flex gap-2 text-truncate fs-12 fw-normal text-muted lh-1 mt-1">
									...
									<li class="dropdown-item">
										<div class="d-flex align-items-center cart-dropdown-item gap-3">
											<div class="lh-1">
												<span class="avatar avatar-md avatar-rounded">
													<img src="{{asset('build/assets/images/ecommerce/jpg/5.jpg')}}" alt="Ceramic Cup">
												</span>
											</div>
											<div class="flex-fill">
												<div class="d-flex align-items-center justify-content-between mb-0">
													<div class="mb-0 fw-medium">
														<a href="{{url('cart')}}">Ceramic Cup</a>
														<div class="d-flex gap-2 text-truncate fs-12 fw-normal text-muted lh-1 mt-1">
								...
								<div class="p-5 empty-item d-none">
									<div class="text-center">
										...
										<a href="{{url('products')}}" class="btn btn-secondary btn-wave btn-sm m-1" data-abc="true">continue shopping <i class="bi bi-arrow-right ms-1"></i></a>
									</div>
								</div>
							</div>
								...
								<ul class="list-unstyled mb-0" id="header-notification-scroll">
									<li class="dropdown-item">
										<div class="d-flex align-items-start">
											...
											<div class="flex-grow-1 d-flex align-items-start justify-content-between">
												<div>
													<p class="mb-0 fw-medium"><a href="{{url('chat')}}">New User Registered</a></p>
									...
									<li class="dropdown-item">
										<div class="d-flex align-items-start">
											...
											<div class="flex-grow-1 d-flex align-items-start justify-content-between">
												<div>
													<p class="mb-0 fw-medium"><a href="{{url('chat')}}">Payment Received</a></p>
										...
										<div class="d-flex align-items-start">
											<div class="pe-2 lh-1">
												<span class="avatar avatar-md bg-orange avatar-rounded">
													<img src="{{asset('build/assets/images/faces/13.jpg')}}" alt="user1">
												</span>
											</div>
											<div class="flex-grow-1 d-flex align-items-start justify-content-between">
												<div>
													<p class="mb-0 fw-medium"><a href="{{url('chat')}}">Task Completed</a></p>
									...
									<li class="dropdown-item">
										<div class="d-flex align-items-start">
											...
											<div class="flex-grow-1 d-flex align-items-start justify-content-between">
												<div>
													<p class="mb-0 fw-medium"><a href="{{url('chat')}}">Server Alert</a></p>
									...
									<li class="dropdown-item">
										<div class="d-flex align-items-start">
											...
											<div class="flex-grow-1 d-flex align-items-start justify-content-between">
												<div>
													<p class="mb-0 fw-medium"><a href="{{url('chat')}}">New Message</a></p>
						...
						<li class="header-element dropdown">
							...
							<a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
								<div class="d-flex align-items-center">
									<div>
										<img src="{{asset('build/assets/images/faces/15.jpg')}}" alt="img" class="avatar custom-header-avatar avatar-rounded">
									</div>
								</div>
							</a>
							<!-- End::header-link|dropdown-toggle -->
							<ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
								...
								<li><a class="dropdown-item d-flex align-items-center" href="{{url('profile')}}"><i class="ri-user-line lh-1 p-1 rounded-circle bg-primary-transparent text-primary me-2 fs-14"></i>Profile</a></li>
								<li><a class="dropdown-item d-flex align-items-center" href="{{url('file-manager')}}"><i class="ri-folder-4-line lh-1 p-1 rounded-circle bg-primary-transparent text-primary me-2 fs-14"></i>File Manger<span class="badge bg-success text-fixed-white ms-auto fs-9">2</span></a></li>
								<li><a class="dropdown-item d-flex align-items-center" href="{{url('mail')}}"><i class="ri-mail-line lh-1 p-1 rounded-circle bg-primary-transparent text-primary me-2 fs-14"></i>Mail Inbox</a></li>
								<li><a class="dropdown-item d-flex align-items-center" href="{{url('mail-settings')}}"><i class="ri-settings-5-line lh-1 p-1 rounded-circle bg-primary-transparent text-primary me-2 fs-14"></i>Settings</a></li>
								<li><a class="dropdown-item d-flex align-items-center" href="{{url('sign-in-cover')}}"><i class="ri-door-lock-line lh-1 p-1 rounded-circle bg-primary-transparent text-primary me-2 fs-14"></i>Log Out</a></li>
							</ul>
						</li>  
						<!-- End::header-element -->
