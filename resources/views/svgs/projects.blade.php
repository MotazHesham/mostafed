<svg viewBox="0 0 24 24" class="w-6 h-6 side-menu__icon" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g id="SVGRepo_iconCarrier">
        <path opacity="0.4"
            ...
            stroke="#1a404d" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
        <path
            ...
            stroke="#1a404d" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
        <path d="M11.995 16.6783V15.3843" stroke="#1a404d" stroke-width="1.5" stroke-linecap="round"
