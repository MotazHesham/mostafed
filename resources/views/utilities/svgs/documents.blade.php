<svg viewBox="0 0 24 24" class="w-6 h-6 side-menu__icon" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g id="SVGRepo_iconCarrier">
        ...
        <path opacity="0.5"
            ...
            stroke="#1C274C" stroke-width="1.5"></path>
        <path opacity="0.7" d="M9 13H15" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"></path>
        <path d="M9 9H15" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"></path>
        <path opacity="0.4" d="M9 17H12" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"></path>
    </g>
</svg>
